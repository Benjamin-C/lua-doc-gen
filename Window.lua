...
---@field bg number Backgroud color
---@field _name string Window name
...
---@field _elements UiElement[] Table of elements in window
---@field __elementIndex number Last element index
---@field _menuOptions MenuOption[] Table of menu options for window bar
---@field __menuIndex number Last menu option index
---@field _nameOffset number Name x offset (calulated)
...
function Window:__constructor__(name, background)
...
function pos.gui.Window(name, background)
    ...
    o:__constructor__(name, background)
    return o
end